/**
 * Entitas Generated Classes for schmupwarz
 *
...
module schmupwarz {
  ...
  export class MineComponent implements IComponent {
  }
  export class StatusComponent implements IComponent {
    public percent:number;
    public immunity:number;
  }
  export class LifeComponent implements IComponent {
    public count:number;
  }
